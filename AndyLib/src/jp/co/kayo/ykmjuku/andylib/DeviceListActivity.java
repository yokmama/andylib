...
public class DeviceListActivity extends DialogFragment {
    ...
    public DeviceListActivity(String tag, boolean secure){
        Bundle args = new Bundle();
        args.putString("tag", tag);
        args.putBoolean("secure", secure);
        setArguments(args);
    }
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            if(mTag!=null){
                ...
                BluetoothComponent bt = (BluetoothComponent)getFragmentManager().findFragmentByTag(mTag);
                bt.connectDevice(intent, mSecure);
            }
