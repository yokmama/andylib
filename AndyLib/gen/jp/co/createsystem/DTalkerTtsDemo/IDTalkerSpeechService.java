 ...
 * Original file: /Users/hijirinhijirin/git/github/andylib/AndyLib/src/jp/co/createsystem/DTalkerTtsDemo/IDTalkerSpeechService.aidl
 */
package jp.co.createsystem.DTalkerTtsDemo;
public interface IDTalkerSpeechService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService
{
private static final java.lang.String DESCRIPTOR = "jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService";
...
/**
 * Cast an IBinder object into an jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService interface,
 * generating a proxy if needed.
 */
public static jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService))) {
return ((jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService)iin);
}
return new jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener _arg0;
_arg0 = jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechService
{
...
@Override public void addListenner(jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeListener(jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addListenner(jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener listener) throws android.os.RemoteException;
public void removeListener(jp.co.createsystem.DTalkerTtsDemo.IDTalkerSpeechServiceCallbackListener listener) throws android.os.RemoteException;
//Clip board speech
